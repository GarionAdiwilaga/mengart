...
**Business Rule:** All status mutations must flow through canonical domain services with in-transaction actor verification. Invitations resolve deterministically. Legacy hash-only tokens are revoked fail-closed with deterministic surrogate codes.
**Reason:** Addressed independent QA review findings for Gate D / Blueprint 2.2.2 final QA hardening.
