  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="p-4 rounded-2xl bg-amber-500/[0.04] border border-amber-500/20 text-xs text-zinc-300 leading-relaxed">
        Masuk menggunakan akun Google Anda untuk memverifikasi identitas dan mengaktifkan keanggotaan studio atelier secara instan.
      </div>
      ...
      <button
        ...
        disabled={isLoading}
        className="w-full py-3.5 px-4 rounded-xl bg-white hover:bg-zinc-100 text-black text-sm font-semibold transition-all shadow-lg hover:shadow-white/10 flex items-center justify-center gap-3 disabled:opacity-50 cursor-pointer disabled:cursor-not-allowed"
      >
        {isLoading ? (
