      ...
      <div className="glass-panel p-4 sm:p-5 rounded-3xl flex flex-col md:flex-row items-center justify-between gap-4 border border-white/10">
        ...
        <div className="relative w-full md:w-80">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 rounded-2xl bg-white/5 border border-white/10 text-white placeholder:text-zinc-500 focus:outline-none focus:border-amber-500/60 text-xs font-sans"
          />
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2 w-full md:w-auto">
          ...
          <button
            ...
            className={`px-3.5 py-2 rounded-2xl border text-xs font-mono transition-all flex items-center gap-1.5 cursor-pointer ${
