...
export async function importHistoricalChallengeService(
  dbOrTx: any,
  actor: { id: string; role: string },
  data: HistoricalChallengeInput
) {
  if (actor.role !== "admin" && actor.role !== "moderator") {
    throw new Error("Hanya administrator atau moderator yang dapat mengimpor data historis.");
  }
  ...
  const run = async (tx: any) => {
    ...
    if (
      ...
      throw new Error("Hanya administrator atau moderator aktif yang dapat mengimpor data historis.");
    }
